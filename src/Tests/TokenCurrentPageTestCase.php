...
class TokenCurrentPageTestCase extends TokenTestBase {
  ...
  function testCurrentPageTokens() {
    ...
    $tokens = array(
      ...
      '[current-page:url]' => \Drupal::url('user', array('absolute' => TRUE)),
      '[current-page:url:absolute]' => \Drupal::url('user', array('absolute' => TRUE)),
      '[current-page:url:relative]' => \Drupal::url('user', array('absolute' => FALSE)),
      '[current-page:url:path]' => 'user',
      '[current-page:url:args:value:0]' => 'user',
      '[current-page:url:args:value:1]' => NULL,
      '[current-page:url:unaliased]' => \Drupal::url('user', array('absolute' => TRUE, 'alias' => TRUE)),
    ...
    $tokens = array(
      ...
      '[current-page:url]' => \Drupal::url("node/{$node->id()}", array('absolute' => TRUE)),
      '[current-page:url:absolute]' => \Drupal::url("node/{$node->id()}", array('absolute' => TRUE)),
      '[current-page:url:relative]' => \Drupal::url("node/{$node->id()}", array('absolute' => FALSE)),
      '[current-page:url:alias]' => 'node-alias',
      '[current-page:url:args:value:0]' => 'node-alias',
      '[current-page:url:args:value:1]' => NULL,
      '[current-page:url:unaliased]' => \Drupal::url("node/{$node->id()}", array('absolute' => TRUE, 'alias' => TRUE)),
