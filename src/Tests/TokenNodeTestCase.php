...
class TokenNodeTestCase extends TokenTestBase {
  ...
  function testNodeTokens() {
    ...
    $tokens = array(
      ...
      'url:absolute' => \Drupal::url("node/{$source_node->id()}", array('absolute' => TRUE)),
      'url:relative' => \Drupal::url("node/{$source_node->id()}", array('absolute' => FALSE)),
      ...
      'content-type:edit-url' => \Drupal::url('admin/structure/types/manage/page', array('absolute' => TRUE)),
      // Deprecated tokens.
      'type' => 'page',
    ...
    $tokens = array(
      ...
      'url:absolute' => \Drupal::url("node/{$translated_node->id()}", array('absolute' => TRUE)),
      'url:relative' => \Drupal::url("node/{$translated_node->id()}", array('absolute' => FALSE)),
      ...
      'content-type:node-count' => 1,
      'content-type:edit-url' => \Drupal::url('admin/structure/types/manage/article', array('absolute' => TRUE)),
      // Deprecated tokens.
      'type' => 'article',
      'type-name' => 'Article',
